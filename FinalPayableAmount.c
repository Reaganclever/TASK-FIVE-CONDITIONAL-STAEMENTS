...
double computeFinalPayableAmount(int membershipDuration , double totalFee){
 ...
 while(1){
        ...
        if(membershipDuration >= 1 && membershipDuration <= 3){
            discountAmount1_3 = totalFee * 0.08;
            discountTotalGymPrice1_3 = totalFee - discountAmount1_3;
            printf("THE NEW DISCOUNT AMOUNT IS %.0lf\n" , discountAmount1_3);
            printf("THE NEW FINAL PAYABLE AMOUNT IS %.2lf\n" , discountTotalGymPrice1_3);
            break;
            ...
            printf("THE NEW DISCOUNT AMOUNT 4+ IS %.0lf\n" , discountAmount_EqualandAbove4);
            printf("THE NEW FINAL PAYABLE AMOUNT 4+ IS %.2lf\n" , discountTotalgymPrice_EqualandAbove4);
            break;
        }
        else{
            printf(" SO INVALID MEMBERSHIP DURATION\n");
            break;
        }
        }
