...
while(1){
       ...
       if(units < 200){
        totalunits1 = units * 0.5;
      printf("TOTAL UNITS LESS THAN 200: ");
      double totalBill_1 = oneUnitCost * totalunits1;
      printf("TOTAL BILL = %.2lf" , totalBill_1);
       break;
       }

       else if(units >= 200){
        totalunits2 = units * 0.75;
       printf("TOTAL UNITS GREATER OR EQUAL TO 200: ");
        double totalBill_2 = oneUnitCost * totalunits2;
        printf("TOTAL BILL  = %.2lf" , totalBill_2);
        break;
